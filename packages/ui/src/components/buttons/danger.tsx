		...
		const button = (
			<button
				...
				className={clsx([
					...
					'!cui-bg-danger hover:!cui-bg-danger-states active:!cui-bg-danger-states focus:!cui-bg-danger-states disabled:!cui-bg-danger-states/75', // background
					'cui-text-foreground-btn cui-font-semibold', // text
